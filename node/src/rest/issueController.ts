...
import {IssueRepository, NotFoundException} from '../domain/issueRepository'
...
export class IssueController {
	...
	async getSingle(req: express.Request, res: express.Response, next: express.NextFunction) {
		try {
	...
	async partialUpdate(req: express.Request, res: express.Response, next: express.NextFunction) {
		try {
			const id = this.getId(req);
